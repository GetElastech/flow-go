...
2. The access node forwards the transaction to one of the Collection nodes in the Collection node cluster to which this transaction belongs to and stores it locally as well.
