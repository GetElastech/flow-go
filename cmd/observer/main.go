...
func main() {
	anb := nodebuilder.FlowAccessNode(nodebuilder.UnstakedService()) // use the generic Access Node builder till it is determined if this is a staked AN or an unstaked AN
