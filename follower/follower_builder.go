...
func FlowObserverService(opts ...FollowerOption) *FollowerServiceBuilder {
	config := DefaultFollowerServiceConfig()
	for _, opt := range opts {
		opt(config)
	}

	return &FollowerServiceBuilder{
...
func WithSkipValidations(builder *FollowerServiceBuilder) *FollowerServiceBuilder {
